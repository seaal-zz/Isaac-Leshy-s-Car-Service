...
public class Improvements extends DefaultService implements ServiceInterface {
	
	private Scanner sc = new Scanner(System.in);

	public Improvements() {
		super("Improvements", true);
	}
	...
	public boolean inputPartInfo() {
		System.out.println("Due to the ambiguity of this service, you will not be able to schedule an appointment " +
							"until we get in contact with you to finalize the details of your request(s). What kinds " +
							"of improvements would you like for your car? If you have multiple requests, place them " +
							"on the same line.");
	...
	public boolean collectAllInfo() {
		...
		try {
			File myObj = new File("CarImprovementsServiceDetails.txt");
		...
		try {
			FileWriter myWriter = new FileWriter("CarImprovementsServiceDetails.txt");
