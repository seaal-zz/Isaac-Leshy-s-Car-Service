...
public class PaintJob extends DefaultService implements ServiceInterface {
	
	private Scanner sc = new Scanner(System.in);

	public PaintJob() {
		super("Paint Job", false);
	}
	
	public boolean inputPartInfo() {
		System.out.println("Enter the paint color desired on your car.");
	...
	public boolean collectAllInfo() {
		...
		try {
			File myObj = new File("CarPaintJobServiceDetails.txt");
		...
		try {
			FileWriter myWriter = new FileWriter("CarPaintJobServiceDetails.txt");
