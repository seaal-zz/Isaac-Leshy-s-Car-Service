...
public class RadioRepair extends DefaultService implements ServiceInterface {
	
	private Scanner sc = new Scanner(System.in);

	public RadioRepair() {
		super("Radio Repair", false);
	}
	
	public boolean inputPartInfo() {
		System.out.println("What part(s) of the radio need to be repaired? If you are not sure, type Unknown.");
	...
	public boolean collectAllInfo() {
		...
		try {
			File myObj = new File("CarRadioRepairServiceDetails.txt");
		...
		try {
			FileWriter myWriter = new FileWriter("CarRadioRepairServiceDetails.txt");
